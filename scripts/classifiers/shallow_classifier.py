...
class SNNClassifier(TorchVisionDatasetClassifier):
    ...
    def build_model(self, compute_batch_size: bool = False) -> None:
        ...
        """
        self.model = SNN(self.dataset_type).to(self.device, non_blocking=self.non_blocking)
        ...
        if compute_batch_size:
            if self.device.type == "cuda":
                ...
                temp_model = SNN(self.dataset_type).to(self.device, non_blocking=self.non_blocking)
